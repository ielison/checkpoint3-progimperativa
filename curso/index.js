module.exports = {
    curso: {
        ...
        resultado: function (aluno){
            ...
            if (aluno.quantFaltas < this.faltasMaximas && media >= this.notaAprovacao) {
            ...
            } else if(aluno.quantFaltas === this.faltasMaximas && media > (this.notaAprovacao * 1.1)){   
        ...
        //Método para percorrer o array lista de alunos e retornar a média e se foi aprovado ou não.
